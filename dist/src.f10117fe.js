...
exports.View = View;
},{}],"src/views/UserFrom.ts":[function(require,module,exports) {
"use strict";
...
var UserFrom_1 = require("./UserFrom");
...
function (_super) {
  ...
  UserEdit.prototype.onRender = function () {
    ...
    new UserFrom_1.UserForm(this.regions.userForm, this.model).render();
  };
...
},{"./View":"src/views/View.ts","./UserFrom":"src/views/UserFrom.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Model.ts":[function(require,module,exports) {
"use strict";
